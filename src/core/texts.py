...
class RegistrationAssistantTexts:
    ...
    def survey_completed():
        return (
            ...
            "\nСейчас поищу для вас свободное окно для записи на пробное занятие."
        )
    ...
    def approve_appointment_time(time: str):
        return (
            ...
            "Подскажите, есть ли у вас еще дети? У нас есть разные бонусы для семей с несколькими детьми  😍"
        )
...
class SlotsTexts:
    ...
    async def slot_validation_text():
        ...
        return (
            f"Тебе нужно вернуть ID слота в зависимости от даты, которую ты получаешь"
            f"\n\nВот список слотов:\n{slots}"
        )
